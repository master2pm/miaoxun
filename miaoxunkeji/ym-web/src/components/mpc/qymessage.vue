...
<div v-if="message!=''" style="margin:0 auto;width:1024px;">
		<p class="f26 c4A494B relative" style="margin:0 20px;margin-top:60px;width:335px;">
			...
			<!-- 企业 -->
			<img v-if="who=='company'" class="cursor" src="/static/tu-detail/1-78.png" alt="" style="position:absolute;top:3px;right:-56px;">
			<!-- 团队 -->
			<img v-if="who=='group'" class="cursor" src="/static/tu-detail/1-77.png" alt="" style="position:absolute;top:3px;right:-56px;">
			<!-- 个人 -->
			<img v-if="who=='private'" class="cursor" src="/static/tu-detail/1-79.png" alt="" style="position:absolute;top:3px;right:-56px;">
		</p>
		...
		methods:{
         ...
         // this.$store.commit("adds",{"e":e,"n":n,"objectId":objectId,'type':type})
			...
			changqr(){
				...
				var test = dz.substring(0,dz.indexOf("new")) + 'phone/detail/miao_gqt.html?id=' + that.message.objectId;
