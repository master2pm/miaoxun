...
const buildAndrz = {
    template: `
   <div style="padding:0 20px;position: relative;" class=" c696A6C">
         ...
         <input v-model="people" type="text" placeHolder="请输入您的企业联系人" name="" style="width:462px;height: 38px;padding:10px 20px;" class="inputborder none rad f15">

         <p class="f18 c696A6C" style="margin-bottom:20px;margin-top:35px;">企业联系电话</p>
         <input v-model="phone" type="text" placeHolder="请输入手机号码或座机号码" name="" style="margin-bottom:110px;width:462px;height: 38px;padding:10px 20px;" class="inputborder none rad f15">
